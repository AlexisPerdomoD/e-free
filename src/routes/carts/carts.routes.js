...
cartRouter.patch('/product/:pid', isUsser, async (req, res, next) => updateCartController(req, res, next))
//delete product directly
cartRouter.delete('/product/:pid', isUsser, async (req, res, next) => deleteProductFromCartController(req, res, next))
//checkout
cartRouter.get('/purchase', isUsser, async (req, res, next) => checkOutCart(req, res, next))
